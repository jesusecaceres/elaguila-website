...
Architecture now locks ES/EN/PT/TL launch scope, hidden future languages, and issue-manifest pipeline — see [`AUGUST-2026-MULTILINGUAL-DIGITAL-TRANSLATION-PIPELINE-ARCHITECTURE.md`](AUGUST-2026-MULTILINGUAL-DIGITAL-TRANSLATION-PIPELINE-ARCHITECTURE.md).
