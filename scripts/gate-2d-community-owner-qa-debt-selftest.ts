...
// ---------------------------------------------------------------------------
{
  ...
  // Gate 3 legitimately owns Mascotas y Perdidos, and Gate 4 legitimately owns Busco, now — neither
  // is forbidden here any more. The durable Revenue-OS concern remains forbidden for every gate.
  ...
  console.log("OK: no Revenue-OS files touched; no DB migration added");
}
