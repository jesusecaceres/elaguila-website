#!/usr/bin/env node
/**
 * August 2026 Batch 3 — Pages 2, 3 & 4 English DeepL digital proof (three pages, max three calls).
 *
 * Gate: AUGUST-2026-BATCH3-PAGES2-4-DEEPL-ENGLISH-PROOF1
 * Usage: node scripts/magazine/proof-translate-august-batch3-pages2-4-deepl.mjs --target=en [--dry-run|--execute]
 *
...
const GATE = "AUGUST-2026-BATCH3-PAGES2-4-DEEPL-ENGLISH-PROOF1";
const NEXT_GATE_SUCCESS = "AUGUST-2026-BATCH3-PAGES2-4-WEB-QA-URL1";
const TARGET = "en";
...
const PAGES = [
  {
    pageNumber: 2,
    inputPath: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-002/source-page-002-from-png.pdf",
    inputMetaPath: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-002/metadata.json",
    outputDir: ".magazine-proof-output/2026-august/en/page-smoke/page-002",
    outputPdf: "deepl-page-002.en.pdf",
    inputFilename: "source-page-002-from-png.pdf",
    riskLevel: "MEDIUM",
    layoutType: "Leonix house ad / brand ad",
    qaFocus: "Leonix ad copy, CTA/contact layout, brand voice, QR/contact blocks",
  },
  {
    pageNumber: 3,
    inputPath: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-003/source-page-003-from-png.pdf",
    inputMetaPath: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-003/metadata.json",
    outputDir: ".magazine-proof-output/2026-august/en/page-smoke/page-003",
    outputPdf: "deepl-page-003.en.pdf",
    inputFilename: "source-page-003-from-png.pdf",
    riskLevel: "HIGH",
    layoutType: "client restaurant ad",
    qaFocus:
      "Cali Bear Tacos business name, food/menu language, offer/CTA/contact preservation",
  },
  {
    pageNumber: 4,
    inputPath: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-004/source-page-004-from-png.pdf",
    inputMetaPath: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-004/metadata.json",
    outputDir: ".magazine-proof-output/2026-august/en/page-smoke/page-004",
    outputPdf: "deepl-page-004.en.pdf",
    inputFilename: "source-page-004-from-png.pdf",
    riskLevel: "HIGH",
    layoutType: "client service/barber ad",
    qaFocus:
      "Elevated Barber business name, service copy, CTA/contact preservation, premium ad tone",
  },
];
...
function buildReadme(pageConfig, providerCalled, providerStatus) {
  return `# Page ${pageConfig.pageNumber} English DeepL Digital Proof (August 2026 · Batch 3)
...
- **Client/ad pages require human polish review before public use**
...
for (const flag of BLOCKED_FLAGS) {
  if (hasFlag(flag)) {
    console.error(`[${GATE}] Refused flag: ${flag}. Batch 3 pages 2, 3 & 4 English only.`);
    process.exit(1);
  }
}
