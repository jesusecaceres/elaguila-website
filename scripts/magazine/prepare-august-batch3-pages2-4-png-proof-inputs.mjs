#!/usr/bin/env node
/**
 * August 2026 Batch 3 — Pages 2, 3 & 4 PNG to one-page PDF proof inputs (prep only).
 *
...
const GATE = "AUGUST-2026-BATCH3-PAGES2-4-PNG-TO-DEEPL-PROOF-PREP1";
const NEXT_GATE = "AUGUST-2026-BATCH3-PAGES2-4-DEEPL-ENGLISH-PROOF1";
...
const PAGES = [
  {
    ...
    padded: "002",
    sourcePng:
      "design-references/magazine/2026-august/01-master-samples/august-2026-leonix-house-ad-master-sample.png",
    outputDir: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-002",
    outputPdf: "source-page-002-from-png.pdf",
    riskLevel: "MEDIUM",
  ...
  },
  {
    ...
    padded: "003",
    sourcePng:
      "design-references/magazine/2026-august/01-master-samples/august-2026-calibear-tacos-master-sample.png",
    outputDir: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-003",
    outputPdf: "source-page-003-from-png.pdf",
    riskLevel: "HIGH",
  ...
  },
  {
    ...
    padded: "004",
    sourcePng:
      "design-references/magazine/2026-august/01-master-samples/august-2026-elevated-barber-master-sample.png",
    outputDir: ".magazine-proof-output/2026-august/_inputs/page-smoke/page-004",
    outputPdf: "source-page-004-from-png.pdf",
    riskLevel: "HIGH",
...
async function preparePage(pageConfig) {
  ...
  const readme = `# Page ${pageConfig.pageNumber} Local Proof Input (August 2026 · Batch 3)
...
\`${NEXT_GATE}\` — controlled English proof (max 3 provider calls: one per page); local output only.
`;
