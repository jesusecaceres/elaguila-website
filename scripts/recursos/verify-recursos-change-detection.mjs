...
// verify-recursos-spanish-bridge-foundation.mjs assertions): this does not freeze the migration
// count at Gate 5's own shipping moment forever — it names every migration legitimately added by
// a LATER, PM-approved gate and fails only on a truly unaccounted one.
