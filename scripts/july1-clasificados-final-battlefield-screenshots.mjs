/**
 * JULY1-CLASIFICADOS-LANDING-RESULTS-MOBILE-FINAL-BATTLEFIELD-RESCUE screenshots.
 * Usage: node scripts/july1-clasificados-final-battlefield-screenshots.mjs [baseUrl]
 */
...
const outDir = path.join(
  ...
  "july1-clasificados-final-battlefield-rescue",
);
...
const categories = [
  ...
  },
  {
    ...
    filterEs: 'button:has-text("Filtros")',
    resultsFilterEs: '[aria-label="Buscar rentas"] button:has-text("Filtros"), form button:has-text("Filtros")',
  },
  {
    slug: "bienes-raices",
  ...
  },
  {
    ...
    resultsFilterEs: 'form button:has-text("Filtros")',
  },
  {
    slug: "empleos",
