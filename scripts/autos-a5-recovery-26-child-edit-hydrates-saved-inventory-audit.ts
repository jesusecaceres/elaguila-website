...
const GATE_ROWS = [
  ...
  "Working Step 7 child source inspected",
  ...
  "Editar hydrates Step 1 fields",
  "Editar hydrates images/media",
  "Editar hydrates image URLs",
  "Editar hydrates media order/cover where supported",
  "Editar hydrates videoUrls",
