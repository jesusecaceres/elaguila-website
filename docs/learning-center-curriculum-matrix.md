...
- Four English strings of the TODAY-1 seed miss a possessive apostrophe (`proteccion_y_datos.summary_en`, `customer_data_protection.summary_en`: "your customers information"; `reviews_and_customer_response.body_en`: "many people decisions", "your customers experience"). They are TODAY-1 content, outside D3 and outside the I-1 seed (which updates no English column) — a small reviewed follow-up correction.
