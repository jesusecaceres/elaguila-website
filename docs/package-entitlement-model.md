...
**Related:** [`print-to-digital-visibility-policy.md`](./print-to-digital-visibility-policy.md) (G0), [`printDigitalVisibilityRank.ts`](../app/lib/listingPlans/printDigitalVisibilityRank.ts) (G1), Gate G1.5 audit, **Admin generator** [`/admin/workspace/package-entitlements`](../app/admin/(dashboard)/workspace/package-entitlements/page.tsx) (G1.6B), **pricing / promo / sales / commission model** [`pricing-promo-code-sales-model.md`](./pricing-promo-code-sales-model.md) (G1.6D — `packagePricingRules.ts`), **promo lifecycle** [`promo-code-lifecycle-model.md`](./promo-code-lifecycle-model.md) (G1.6F — `leonix_promo_codes` + `/admin/workspace/promo-codes`), **redemption / attachment** [`entitlement-redemption-attachment-model.md`](./entitlement-redemption-attachment-model.md) (G1.6G — `entitlementRedemption.ts` + admin sync), **sales tracker** [`sales-rep-dashboard-model.md`](./sales-rep-dashboard-model.md) (G1.6H — `/admin/workspace/sales-tracker`), **payment tracker** [`stripe-payment-tracker-model.md`](./stripe-payment-tracker-model.md) (G1.6I — `/admin/workspace/payment-tracker`), **sales rep admin access** [`admin-sales-rep-access-model.md`](./admin-sales-rep-access-model.md) (ADMIN-ROLES-SALES).

**Sales rep access (ADMIN-ROLES-SALES):** Sales reps manage only entitlements whose `metadata.sales_rep_id` matches their roster-derived id; create actions auto-assign rep fields. Owner/admin can view all rows and override attribution. Commission metadata remains preview-only; no payout in this gate.
