...
select summary_en from public.business_learning_lessons where lesson_key = 'customer_data_protection';
...
-- Parts B and C: restore the affected *_es / *_en values from the step-4 export if required
commit;
```
