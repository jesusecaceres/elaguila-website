...
const COPY = {
  es: {
    common: {
      ...
      savedInDraft: "✅ Imagen aceptada",
      logoSavedInDraft: "✅ Logo aceptado",
      fileSavedInDraft: "✅ Archivo aceptado",
    ...
    sectionD: {
      ...
      smsLabel: "SMS / mensajes de texto",
      smsHelper: "Número aparte para «Mensaje». No se copia del teléfono de oficina.",
  ...
  en: {
    common: {
      ...
      savedInDraft: "✅ Image accepted",
      logoSavedInDraft: "✅ Logo accepted",
      fileSavedInDraft: "✅ File accepted",
    ...
    sectionD: {
      ...
      smsLabel: "SMS / text messages",
      smsHelper: "Separate number for «Message». Never copied from the office phone.",
