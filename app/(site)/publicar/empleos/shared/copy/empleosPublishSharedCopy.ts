export const EMPLEOS_PUBLISH_SHARED_COPY = {
  es: {
    ...
    finalStep: {
      ...
      deleteConfirm: "¿Eliminar esta solicitud de la sesión? Se perderán los cambios no publicados.",
      confirmationTitle: "Confirmación antes de publicar",
      confirmationHelper: "Estas casillas ayudan a mantener Leonix claro y confiable para todos.",
      confirmationLinkLabel: "Ver reglas de Leonix",
      confirmationLinkUrl: "/reglas",
      checkbox1: "Confirmo que la información de este empleo es veraz y actualizada.",
      checkbox2: "Confirmo que las imágenes, videos o documentos que subí pertenecen a este empleo o empresa.",
      checkbox3: "Confirmo que esta publicación cumple con las reglas de Leonix y que soy responsable por la información publicada.",
      readyMessage: "Listo para publicar · puedes enviar tu anuncio de empleo.",
      missingConfirmationsMessage: "Completa las confirmaciones para activar la vista previa y publicación.",
      priceSummaryTitle: "Resumen de precios",
      priceSummaryItem: "Empleos — $24.99 por 30 días",
      priceSummaryHelper: "Anuncio de empleo pagado · publicación por 30 días",
      priceSummaryTotal: "Total — $24.99",
    },
    stagedSuccess:
  ...
  en: {
    ...
    finalStep: {
      title: "Final review",
      intro:
        "When you finish the confirmations above, use the buttons below to open the preview or publish. Your progress is saved in this session.",
      ...
      deleteConfirm: "Delete this application from the session? Unpublished changes will be lost.",
      confirmationTitle: "Confirmation before publishing",
      confirmationHelper: "These confirmations help keep Leonix clear and trustworthy for everyone.",
      confirmationLinkLabel: "View Leonix rules",
      confirmationLinkUrl: "/reglas",
      checkbox1: "I confirm this job information is accurate and up to date.",
      checkbox2: "I confirm the images, videos, or documents I uploaded belong to this job or company.",
      checkbox3: "I confirm this job post follows Leonix rules and I am responsible for the published information.",
      readyMessage: "Ready to publish · you can submit your job post.",
      missingConfirmationsMessage: "Complete the confirmations to activate preview and publishing.",
      priceSummaryTitle: "Price summary",
      priceSummaryItem: "Jobs — $24.99 for 30 days",
      priceSummaryHelper: "Paid job listing · 30-day publication",
      priceSummaryTotal: "Total — $24.99",
    },
    stagedSuccess:
