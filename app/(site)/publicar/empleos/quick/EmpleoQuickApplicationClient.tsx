  ...
  const mediaCopy =
    lang === "es"
      ? {
          ...
          videoHint: "Agrega un enlace público de YouTube, TikTok, Instagram u otra plataforma compatible. No se suben archivos de video.",
          videoUrlField: "URL del video",
          videoUrlPh: "https://…",
          videoApplyUrl: "Usar URL",
          videoPickFile: "",
          videoClear: "Quitar video",
          videoInvalidUrl: "Usa un enlace público que empiece con http:// o https://.",
      ...
      : {
          ...
          videoHint: "Add a public link from YouTube, TikTok, Instagram, or another supported platform. Video files are not uploaded.",
          videoUrlField: "Video URL",
          videoUrlPh: "https://…",
          videoApplyUrl: "Apply URL",
          videoPickFile: "",
          videoClear: "Remove video",
          videoInvalidUrl: "Use a public video URL that starts with http:// or https://.",
