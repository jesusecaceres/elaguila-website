...
export const VIAJES_PRIVADO_DRAFT_V2_STORAGE_KEY = "leonix:viajes:privado:draft:v2";

export type ViajesPrivadoDraftV2 = {
  schemaVersion: 2;
  offer: ViajesOfferModelV2;
};

export function emptyViajesPrivadoDraftV2(locale: "es" | "en" = "es"): ViajesPrivadoDraftV2 {
  return {
    schemaVersion: 2,
    offer: emptyViajesOfferModelV2("private", locale),
  };
}

export function sanitizeViajesPrivadoDraftV2ForStorage(draft: ViajesPrivadoDraftV2): ViajesPrivadoDraftV2 {
  return {
    schemaVersion: 2,
    offer: {
      ...draft.offer,
      ...
      locations: {
        ...draft.offer.locations,
        privateExact: {
          ...draft.offer.locations.privateExact,
          showPublicly: false,
          showMap: false,
        },
      },
...
export function mergeViajesPrivadoDraftV2FromPartial(
  parsed: Partial<ViajesPrivadoDraftV2> & { offer?: Partial<ViajesOfferModelV2> },
  locale: "es" | "en" = "es",
): ViajesPrivadoDraftV2 {
  const base = emptyViajesPrivadoDraftV2(locale);
  ...
  return {
    ...
    offer: {
      ...
      locations: {
        ...base.offer.locations,
        ...(parsed.offer.locations ?? {}),
        privateExact: {
          ...base.offer.locations.privateExact,
          ...(parsed.offer.locations?.privateExact ?? {}),
          showPublicly: false,
          showMap: false,
        },
      },
      ...
      source: { ...base.offer.source, ...(parsed.offer.source ?? {}), lane: "private" },
