...
function es(): PublicarViajesPrivadoCopy {
  return {
    ...
    departureCity: { label: "Ciudad o punto de salida", placeholder: "Ej. San José, California (SJC)" },
...
function en(): PublicarViajesPrivadoCopy {
  return {
    ...
    departureCity: { label: "Departure city or origin", placeholder: "e.g. San José, California (SJC)" },
