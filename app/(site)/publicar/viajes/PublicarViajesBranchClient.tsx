    ...
    >
      ...
      <div className="mx-auto w-full min-w-0 max-w-3xl px-4 sm:px-6">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2">
          ...
          {privateLaneDisabled ? (
            <div className={`${CARD} cursor-not-allowed opacity-75`} aria-disabled="true">
              ...
              <h2 className="mt-4 text-lg font-bold text-[color:var(--lx-text)]">{copy.privadoDisabledTitle}</h2>
              <p className="mt-2 flex-1 text-sm leading-relaxed text-[color:var(--lx-text-2)]">{copy.privadoDisabledBody}</p>
            </div>
          ) : (
