...
export function ClasesQuickPreviewCard({ draft, lang }: { draft: ClasesQuickDraft; lang: Lang }) {
  return <ClasesQuickAdCanvas draft={draft} lang={lang} shell="embedded" contactSectionId="contact-actions" heroTestId="community-anuncio-hero" />;
}

export function ComunidadQuickPreviewCard({ draft, lang }: { draft: ComunidadQuickDraft; lang: Lang }) {
  return <ComunidadQuickAdCanvas draft={draft} lang={lang} shell="embedded" contactSectionId="contact-actions" heroTestId="community-anuncio-hero" />;
}
