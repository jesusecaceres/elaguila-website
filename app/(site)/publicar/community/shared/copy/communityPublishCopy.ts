...
export const CLASES_QUICK_COPY = {
  es: {
    ...
    fields: {
      ...
      scheduleDayPh: "Día o bloque (ej. Sáb)",
      ...
      venue: "Nombre del lugar (opcional)",
      addressLine1: "Dirección (opcional)",
    },
    primaryCtaHint:
  ...
  en: {
    ...
    fields: {
      ...
      scheduleDayPh: "Day or block (e.g. Sat)",
