...
const COPY = {
  es: {
    ...
    aiReviewApproveAndNext: "Aprobar y seguir",
    ...
    aiReviewPageComplete: "Página {page} completa. Puedes continuar a la siguiente página.",
    aiReviewLaterHelper:
    ...
    aiReviewCompleteCount: "{count} productos revisados.",
  ...
  en: {
    ...
    aiReviewApproveAndNext: "Approve & next",
    ...
    aiReviewPageComplete: "Page {page} complete. You can proceed to the next page.",
    aiReviewLaterHelper:
    ...
    aiReviewCompleteCount: "{count} products reviewed.",
