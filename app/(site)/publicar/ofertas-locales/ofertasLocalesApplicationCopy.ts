...
const COPY = {
  es: {
    ...
    freeLabel: "GRATIS",
    couponsStepIntro:
      "Agrega tus cupones principales individualmente para que los compradores puedan encontrarlos en las búsquedas de Leonix. Si tienes más promociones, también puedes subir tu flyer completo.",
    couponEntryHeading: "Cupón {index}",
    couponEntryTitleLabel: "Título del cupón",
    couponEntryDescriptionLabel: "Descripción",
    couponEntryCodeLabel: "Código de cupón",
    couponEntryExpirationLabel: "Fecha de vencimiento",
    couponEntryRedemptionNoteLabel: "Nota de canje",
    couponEntryRedemptionNoteHelper: "Ej. Muestra este cupón en tienda, válido solo en línea, etc.",
    couponEntryImageLabel: "Imagen del cupón",
    couponEntryImageUploadButton: "Subir imagen",
    couponEntryImageUploading: "Subiendo imagen…",
    couponEntryImageUploadFailed: "No se pudo subir la imagen.",
    couponEntryImageAdded: "✓ Imagen añadida",
    couponEntryImageRemove: "Quitar imagen",
    couponEntryImageUrlLabel: "O pega la URL de una imagen",
    couponEntryImageEitherOrHint: "Sube una imagen o pega una URL — no necesitas las dos.",
    couponEntryRemove: "Eliminar cupón",
    couponEntryAddCta: "+ Añadir cupón",
    couponsPromoFlyerTitle: "Flyer de cupones o promociones",
    couponsPromoFlyerHelper:
      "Opcional: sube tu flyer completo de cupones o promociones. No se analiza con IA — solo se muestra tal como lo subas.",
    couponsMoreOffersTitle: "Enlace para ver más ofertas",
    couponsMoreOffersHelper: "URL externa donde los clientes pueden ver más cupones o promociones.",
    couponsMoreOffersUrlPlaceholder: "https://ejemplo.com/mas-cupones",
    couponsMoreOffersButtonLabel: "Texto del botón",
    couponsMoreOffersButtonPlaceholder: "Ver más cupones",
  ...
  en: {
    ...
    freeLabel: "FREE",
    couponsStepIntro:
      "Add your main coupons individually so shoppers can find them in Leonix search. If you have more promotions, you can also upload your full flyer.",
    couponEntryHeading: "Coupon {index}",
    couponEntryTitleLabel: "Coupon title",
    couponEntryDescriptionLabel: "Description",
    couponEntryCodeLabel: "Coupon code",
    couponEntryExpirationLabel: "Expiration date",
    couponEntryRedemptionNoteLabel: "Redemption note",
    couponEntryRedemptionNoteHelper: "E.g. Show this coupon in store, online only, etc.",
    couponEntryImageLabel: "Coupon image",
    couponEntryImageUploadButton: "Upload image",
    couponEntryImageUploading: "Uploading image…",
    couponEntryImageUploadFailed: "Could not upload the image.",
    couponEntryImageAdded: "✓ Image added",
    couponEntryImageRemove: "Remove image",
    couponEntryImageUrlLabel: "Or paste an image URL",
    couponEntryImageEitherOrHint: "Upload an image or paste a URL — you don't need both.",
    couponEntryRemove: "Remove coupon",
    couponEntryAddCta: "+ Add coupon",
    couponsPromoFlyerTitle: "Coupon or promotions flyer",
    couponsPromoFlyerHelper:
      "Optional: upload your complete coupons or promotions flyer. It is not analyzed with AI — it's shown exactly as you upload it.",
    couponsMoreOffersTitle: "Link to see more offers",
    couponsMoreOffersHelper: "External URL where customers can see more coupons or promotions.",
    couponsMoreOffersUrlPlaceholder: "https://example.com/more-coupons",
    couponsMoreOffersButtonLabel: "Button text",
    couponsMoreOffersButtonPlaceholder: "View more coupons",
