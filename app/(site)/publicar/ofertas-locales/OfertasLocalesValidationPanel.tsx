    ...
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="rounded-xl border border-[#D4C4A8]/70 bg-[#FDF8F0] p-4">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-[#7A1E2C]">
          {OFERTAS_LOCALES_SHELL_COPY.validationPreviewTitle}
        </h3>
        <div className="mt-2">
          {previewReady ? (
            <p className="text-xs font-medium text-[#1E1814]/70">
              {OFERTAS_LOCALES_SHELL_COPY.previewReady}
            </p>
          ) : (
            <IssueList
              issues={previewIssues}
              emptyMessage={OFERTAS_LOCALES_SHELL_COPY.previewReady}
              tone="preview"
            />
          )}
        </div>
      ...
      <div className="rounded-xl border border-[#D4C4A8]/70 bg-white p-4">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-[#1E1814]/70">
          {OFERTAS_LOCALES_SHELL_COPY.validationPublishTitle}
        </h3>
        <div className="mt-2">
          {publishFieldsReady ? (
