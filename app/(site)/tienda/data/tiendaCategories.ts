...
export const tiendaCategories: TiendaCategory[] = [
  ...
  },
  {
    ...
    title: { es: "Stickers y etiquetas adhesivas", en: "Stickers & adhesive labels" },
    description: {
      es: "Etiquetas, stickers y piezas troqueladas para marca, empaques y promos.",
      en: "Labels, stickers, and die-cut pieces for brand, packaging, and promos.",
    },
  ...
  },
  {
    ...
    description: {
      es: "Menús, postales, mailers y piezas de campaña — impresión con criterio editorial y coordinación con Leonix.",
      en: "Menus, postcards, mailers, and campaign print — editorial-quality pieces coordinated with Leonix.",
    },
