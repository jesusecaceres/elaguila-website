...
type RootIntroPageClientProps = {
  siteUnlocked: boolean;
};

export function RootIntroPageClient({ siteUnlocked }: RootIntroPageClientProps) {
  return (
      ...
      >
        <div className="pointer-events-auto w-full max-w-[92%] min-w-0 overflow-visible sm:max-w-[440px] md:max-w-[520px]">
          <Suspense fallback={<RootIntroPanelFallback />}>
            <RootIntroLanguagePanel siteUnlocked={siteUnlocked} />
          </Suspense>
        </div>
      </motion.div>
    </main>
