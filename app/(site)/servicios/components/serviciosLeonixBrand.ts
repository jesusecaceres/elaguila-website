...
export const LX = {
  ...
  whatsAppDark: "#1DA851",
  trustGreen: "#2D5A3D",
  trustGreenSoft: "rgba(45, 90, 61, 0.12)",
} as const;
...
export const LX_CTA_WHATSAPP =
  "inline-flex min-h-[44px] min-w-0 touch-manipulation items-center justify-center gap-2 rounded-lg border-0 px-4 py-2.5 text-sm font-bold text-white shadow-md transition hover:brightness-[1.05] active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/40";
