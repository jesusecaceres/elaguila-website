 ...
 * the Idea Builder note states the truth (the tool requires sign-in). Retained but not rendered
 * since the G1 polish: the landing and the pathways both use the compact LearningToolsRow.
 */
