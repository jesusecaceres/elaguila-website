...
export async function clearRentasPrivadoDraft(): Promise<void> {
  ...
  // NEW application in this tab must not inherit it and overwrite the abandoned pending row. Never called
  // on back / edit / retry / cancel (recovery port of 1e80c0240).
