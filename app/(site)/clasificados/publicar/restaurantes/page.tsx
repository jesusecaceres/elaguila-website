...
const COPY = {
  es: {
    ...
    card2More: "Ver más",
    card2MoreTitle: "Qué incluye Puesto / Pop-up / Vendedor móvil — $129/mes",
    card2MoreDetails:
  ...
  en: {
    ...
    card1More: "See more",
    card1MoreTitle: "What's included with Established restaurant — $399/month",
    card1MoreDetails:
    ...
    card2More: "See more",
    card2MoreTitle: "What's included with Stand / Pop-up / Mobile vendor — $129/month",
    card2MoreDetails:
