...
const es: ClasificadosServiciosCopy = {
  ...
  publishCta: "Publicar",
  publishModalTitle: "Publicar perfil de servicio",
  publishModalIntro:
    "Revisamos que tu perfil de servicio tenga lo esencial para la vitrina pública. Al publicar verás la confirmación y tu perfil en Leonix.",
  publishMissingTitle: "Para habilitar Publicar, completa lo siguiente:",
  ...
  listingPhasePublish: "Listo para publicar · puedes enviar tu perfil de servicio.",
...
const en: ClasificadosServiciosCopy = {
  ...
  previewCta: "Preview",
  publishCta: "Publish",
  publishModalTitle: "Publish service profile",
  publishModalIntro:
    "We verify essentials for your public service profile. After publishing you’ll see confirmation and your profile on Leonix.",
  publishMissingTitle: "To enable Publish, complete the following:",
  ...
  listingPhasePublish: "Publish-ready · you can submit your service profile.",
