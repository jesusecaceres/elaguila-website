...
const COPY = {
  es: {
    ...
    priceMode: "Precio",
    priceMoney: "Precio",
    amountLabel: "Precio del artículo (USD)",
    amountH: "Escribe el precio en dólares. Si aceptas ofertas, usa Precio negociable.",
    priceFree: "Gratis",
    ...
    qtyH: "Cuántas unidades vendes. No es el precio.",
  ...
  en: {
    ...
    amountLabel: "Item price (USD)",
    amountH: "Enter the price in dollars. If you accept offers, use Negotiable price.",
    priceFree: "Free",
    ...
    qtyH: "How many units you are selling. This is not the price.",
