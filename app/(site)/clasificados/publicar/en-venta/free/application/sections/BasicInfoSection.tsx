...
const COPY = {
  es: {
    ...
    priceMode: "Precio",
    priceMoney: "Precio",
    amountLabel: "Precio del artículo (MXN)",
    amountH: "Escribe el precio aquí. Si aceptas ofertas, usa Precio negociable.",
    priceFree: "Gratis",
  ...
  en: {
    ...
    amountLabel: "Item price (MXN)",
    amountH: "Enter the price here. If you accept offers, use Negotiable price.",
    priceFree: "Free",
