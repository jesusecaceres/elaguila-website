...
export type RentasPublicListing = {
  ...
  /** Real stored Google/Yelp review-URL destinations only (never a fabricated rating/count), from
   * `listings.business_meta` (`negocioGoogleReviewsUrl` / `negocioYelpReviewsUrl`). */
