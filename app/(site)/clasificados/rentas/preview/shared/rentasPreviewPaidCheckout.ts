...
export function rentasPreviewCheckpointConfig(
  ...
  return {
    ...
    pipeline: lane,
    baseLineItem: {
      labelEn: isNegocio ? "Business rental listing" : "Rental listing",
      labelEs: isNegocio ? "Anuncio de renta negocio" : "Anuncio de renta",
      priceCents,
      ...
      durationSuffixEn: "30 days",
      durationSuffixEs: "30 días",
    },
