...
import { BR_HEADER_SAFE_TOP, BR_LANDING_LANE } from "../shared/bienesRaicesLeonixPublicUi";

/** Page shell — warm Leonix city-living atmosphere, wide premium gateway lane. */
export function BienesRaicesLandingShell({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#F3EBDD] text-[#1F241C]">
      ...
      <div
        className={`${BR_LANDING_LANE} relative px-3.5 pb-14 sm:px-5 lg:px-6 ${BR_HEADER_SAFE_TOP}`}
      >
        {children}
      </div>
    </div>
