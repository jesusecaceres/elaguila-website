...
export function bienesRaicesFsboPreviewCheckpointConfig(lang: "es" | "en"): PublishCheckpointConfig {
  ...
  return {
    ...
    pipeline: "privado",
    baseLineItem: {
      labelEn: "Bienes Raíces FSBO package",
      labelEs: "Paquete Bienes Raíces FSBO",
      priceCents: packageDef?.priceCents ?? 0,
      detailEn: `${durationDays} days · one property per listing · no inventory`,
      detailEs: `${durationDays} días · una propiedad por anuncio · sin inventario`,
      durationSuffixEn: `${durationDays} days`,
      durationSuffixEs: `${durationDays} días`,
    },
