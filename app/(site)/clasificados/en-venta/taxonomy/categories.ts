...
export const EN_VENTA_DEPARTMENTS: Array<{
  ...
  { key: "electronicos", label: { es: "Electrónica", en: "Electronics" }, browseHint: { es: "Teléfonos, laptops, audio", en: "Phones, laptops, audio" } },
  ...
  { key: "musica-foto-video", label: { es: "Música / video", en: "Music / video" }, browseHint: { es: "Instrumentos, cámaras", en: "Instruments, cameras" } },
