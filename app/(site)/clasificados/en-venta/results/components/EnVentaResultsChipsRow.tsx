...
const railClass =
  "flex snap-x snap-mandatory gap-2 overflow-x-auto scroll-pl-1 scroll-pr-1 pb-1 [-webkit-overflow-scrolling:touch] [-ms-overflow-style:none] [scrollbar-width:none] sm:flex-wrap sm:overflow-visible sm:scroll-pl-0 sm:scroll-pr-0 [&::-webkit-scrollbar]:hidden";
