...
export const VIAJES_NEGOCIOS_FIELD_AUDIT: ViajesFieldRow[] = [
  ...
  { field: "precio", lane: "business", stored: "listing_json.negocios.precio", publicFilters: "— (free text)", resultsCard: "price", detailPage: "priceFrom", moderation: "listing_json", ownerDash: "edit", classification: "not_public_browse (no price facet in URL contract)" },
  ...
  { field: "guiaEspanol", lane: "business", stored: "listing_json.negocios.guiaEspanol", publicFilters: "— (no dedicated URL facet)", resultsCard: "—", detailPage: "whoItsFor / tags", moderation: "listing_json", ownerDash: "edit", classification: "not_public_browse" },
  { field: "idiomaAtencion", lane: "business", stored: "listing_json.negocios.idiomaAtencion", publicFilters: "—", resultsCard: "—", detailPage: "whoItsFor", moderation: "listing_json", ownerDash: "edit", classification: "not_public_browse" },
...
export const VIAJES_PRIVADO_FIELD_AUDIT: ViajesFieldRow[] = [
  ...
  { field: "precio", lane: "private", stored: "listing_json.privado.precio", publicFilters: "—", resultsCard: "price", detailPage: "priceFrom", moderation: "listing_json", ownerDash: "edit", classification: "not_public_browse" },
  ...
  { field: "guiaEspanol / idiomaAtencion", lane: "private", stored: "listing_json.privado.*", publicFilters: "—", resultsCard: "—", detailPage: "whoItsFor", moderation: "listing_json", ownerDash: "edit", classification: "not_public_browse" },
