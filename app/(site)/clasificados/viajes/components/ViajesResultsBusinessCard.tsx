  ...
  return (
    <article className="flex h-full min-w-0 flex-col overflow-hidden rounded-2xl border border-[color:var(--lx-gold-border)] bg-[color:var(--lx-card)] shadow-[0_10px_30px_-18px_rgba(42,36,22,0.2)]">
      ...
      <div className="flex flex-1 flex-col p-3">
        ...
        <p className="mt-1.5 line-clamp-2 text-sm leading-relaxed text-[color:var(--lx-text-2)]">{row.includedSummary}</p>
        <p className="mt-1.5 text-xs text-[color:var(--lx-muted)]">{row.duration}</p>
        ...
        <div className="mt-auto flex flex-col gap-2 pt-3 sm:flex-row sm:flex-wrap">
          <Link
            href={offerHref}
            className="inline-flex min-h-[38px] flex-1 items-center justify-center rounded-xl bg-[color:var(--lx-cta-dark)] px-3 text-sm font-bold text-[#FFFCF7] shadow-md transition hover:bg-[color:var(--lx-cta-dark-hover)]"
          >
          ...
          <Link
            href={offerHref}
            className="inline-flex min-h-[38px] flex-1 items-center justify-center rounded-xl border border-[color:var(--lx-cta-dark)] bg-transparent px-3 text-sm font-bold text-[color:var(--lx-cta-dark)] transition hover:bg-[color:var(--lx-nav-hover)]"
          >
