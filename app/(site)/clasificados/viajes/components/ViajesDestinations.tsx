...
export function ViajesDestinations() {
  return (
    <section className="mt-12 sm:mt-14 md:mt-16">
      <ViajesSectionHeader title="Explora destinos populares" className="mb-6 sm:mb-8" />
        ...
        {VIAJES_DESTINATION_COLLECTIONS.map((d) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-4 sm:p-5">
              ...
              <p className="mt-2 flex-1 text-sm leading-relaxed text-[color:var(--lx-text-2)]">{d.supportingLine}</p>
              <Link
                href={d.href}
