...
export const autosPreviewMainGridClass =
  "grid min-w-0 grid-cols-1 gap-5 sm:gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(280px,340px)] lg:items-start lg:gap-7";

export const autosPreviewPremiumCardClass =
  "rounded-[16px] border border-[#D6C7AD]/85 bg-[#FFFDF7] shadow-[0_10px_28px_-16px_rgba(31,36,28,0.14)]";

export const autosPreviewBusinessHubShellClass =
  "overflow-hidden rounded-[16px] border border-[#D6C7AD]/80 bg-[#FFFDF7] shadow-[0_10px_28px_-16px_rgba(31,36,28,0.14)]";
...
export const autosRelatedInventoryShelfScrollClass =
  "-mx-[max(1rem,env(safe-area-inset-left))] flex snap-x snap-mandatory gap-4 overflow-x-auto overscroll-x-contain px-[max(1rem,env(safe-area-inset-left))] pb-2 pt-1 [scrollbar-width:thin] lg:mx-0 lg:px-0";

export const autosRelatedInventoryShelfCardShellClass =
  "w-[68vw] max-w-[240px] shrink-0 snap-start sm:w-[220px] sm:max-w-[240px]";

/** Quieter, non-shouty draft-card label treatment (item 2 preview polish). */
export const autosPreviewQuietDraftLabelClass = "text-[11px] font-medium text-[#8A7A68]";

export const autosPreviewBuyerTrustStripClass =
  "mx-auto grid max-w-[1280px] grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4";
