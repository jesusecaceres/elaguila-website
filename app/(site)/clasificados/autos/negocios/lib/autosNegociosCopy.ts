...
const ES: AutosNegociosCopy = {
  ...
  media: {
    ...
    videoDraftNote:
      "Para lanzamiento, Autos publica videos mediante enlaces externos. No se suben archivos de video desde este formulario.",
    videoLinkTab: "Enlace",
    videoFileTab: "Enlace externo",
    ...
    chooseVideo: "Agregar enlace de video",
    videoReady: "Video externo guardado en el borrador",
    videoReplace: "Reemplazar",
    videoFileHint: "Pega enlaces https de YouTube, TikTok, Instagram, Vimeo u otra plataforma compatible.",
    videoChooseMode: "Agrega enlaces externos para el video.",
    logoHeading: "Logo del concesionario",
...
const EN: AutosNegociosCopy = {
  ...
  media: {
    ...
    videoDraftNote:
      "For launch, Autos publishes videos through external links. Video files are not uploaded from this form.",
    videoLinkTab: "Link",
    videoFileTab: "External link",
    removeVideo: "Remove video",
    videoUrlLabel: "Video URL",
    useVideoUrl: "Use this link",
    videoUrlSaved: "Video via link — saved in draft",
    chooseVideo: "Add video link",
    videoReady: "External video saved in draft",
    videoReplace: "Replace",
    videoFileHint: "Paste https links from YouTube, TikTok, Instagram, Vimeo, or another compatible platform.",
    videoChooseMode: "Add external links for video.",
