    ...
    <div className="flex flex-col items-center gap-2.5 rounded-2xl border border-dashed border-[#C9A84A]/55 bg-gradient-to-b from-[#FBF6EC] to-[#F6EFDF] px-4 py-5 text-center sm:flex-row sm:justify-between sm:text-left">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 max-w-xl text-[13px] leading-relaxed text-[#5a4f3a]">
          {lang === "en"
            ? "Featured spaces are reserved for businesses with Leonix visibility packages, magazine placement, digital promotion, or approved campaigns."
        ...
        <Link
          href={publishHref}
          className="mt-1.5 inline-flex text-[12px] font-semibold text-[#5a4f3a] underline underline-offset-2 hover:text-[#7A1E2C]"
        >
          {lang === "en"
            ? "You can also publish a standard service listing."
