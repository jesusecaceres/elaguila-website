...
export function ServiciosLandingBrowseRow({ lang }: { lang: Lang }) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[min(100%,920px)] flex-col items-stretch gap-3 rounded-[18px] border border-[#dfe6ef]/90 bg-white/80 px-4 py-4 shadow-[0_12px_36px_-28px_rgba(20,38,58,0.35)] ring-1 ring-[#1e3a5f]/[0.04] md:flex-row md:items-center md:justify-between md:gap-6 md:px-6 md:py-4">
      <p className="text-center text-[14px] leading-snug text-[#4a5d6e] md:text-left md:text-[15px]">
        {lang === "en"
