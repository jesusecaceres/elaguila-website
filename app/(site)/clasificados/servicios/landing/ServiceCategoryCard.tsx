...
export function ServiceCategoryCard({
  ...
  return (
    ...
    >
      <div className="flex h-[3.35rem] w-[3.35rem] items-center justify-center rounded-xl bg-gradient-to-b from-[#f7f1e6] to-[#efe5d2] text-[#7A1E2C] shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] ring-1 ring-[#7A1E2C]/[0.08] sm:h-[4.5rem] sm:w-[4.5rem] sm:rounded-2xl">
        <ServiceCategoryGlyph
          id={cat.id}
          className="h-[1.6rem] w-[1.6rem] transition duration-200 group-hover:scale-105 sm:h-[2rem] sm:w-[2rem]"
        />
      </div>
