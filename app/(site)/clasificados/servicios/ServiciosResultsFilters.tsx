...
/** Advanced-only refinements (drawer); excludes q, city, and sort. */
      ...
      >
        ...
        <div className="flex flex-wrap items-end gap-2">
          ...
          >
            ...
            {hasAdvancedFilters ? (
              <span
                className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-[#3B66AD] px-1 text-[10px] font-bold text-white"
                aria-hidden
              >
                •
              </span>
