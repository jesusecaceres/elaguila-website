...
export const CATEGORY_STANDARD_COPY: Record<CategoryStandardKey, CategoryStandardCopyEntry> = {
  ...
  comunidad: {
    ...
    quickFiltersEs: ["Eventos", "Ayuda", "Avisos", "Voluntariado", "Otros"],
    quickFiltersEn: ["Events", "Help", "Notices", "Volunteer", "Other"],
  },
  clases: {
    titleEs: "Clases",
    titleEn: "Classes",
    ...
    quickFiltersEs: ["Idiomas", "Música", "Tutoría", "Arte", "Computación", "Otros"],
    quickFiltersEn: ["Languages", "Music", "Tutoring", "Art", "Computer", "Other"],
  },
  busco: {
    titleEs: "Busco / Se busca",
    titleEn: "Wanted / Looking for",
    descEs:
      "Publica solicitudes para encontrar artículos, ayuda, personas para actividades, grupos, transporte, recursos o algo específico que necesitas.",
    descEn:
      "Post requests to find items, help, people for activities, groups, transportation, resources, or something specific you need.",
    searchPhEs: "Buscar solicitudes, necesidades…",
    searchPhEn: "Search requests, needs…",
    quickFiltersEs: ["Ayuda", "Transporte", "Comunidad", "Recursos", "Otros"],
    quickFiltersEn: ["Help", "Transportation", "Community", "Resources", "Other"],
  },
  "mascotas-y-perdidos": {
    titleEs: "Mascotas y Perdidos",
    titleEn: "Pets & Lost",
    descEs:
      "Avisos gratuitos para mascotas perdidas o encontradas, adopciones y objetos perdidos o encontrados.",
    descEn: "Free notices for lost or found pets, adoptions, and lost or found items.",
