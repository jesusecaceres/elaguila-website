...
export const CATEGORY_STANDARD_COPY: Record<CategoryStandardKey, CategoryStandardCopyEntry> = {
  ...
  comunidad: {
    ...
    descEn: "Find activities, gatherings, notices, and community moments.",
    ...
    quickFiltersEn: ["Events", "Help", "Notices", "Volunteer", "Families", "Community", "Free"],
  },
  clases: {
    titleEs: "Clases",
    titleEn: "Classes",
    ...
    quickFiltersEn: ["Languages", "Music", "Tutoring", "Art", "Computing", "Trades", "Kids"],
  },
  busco: {
    ...
    quickFiltersEn: ["Need", "Job search", "Transport", "Help", "Recommendation", "Lost", "Community"],
  },
  "mascotas-y-perdidos": {
    titleEs: "Mascotas y Perdidos",
    titleEn: "Pets & Lost & Found",
    descEs: "Avisos para mascotas perdidas o encontradas, adopciones y objetos perdidos.",
    descEn: "Lost or found pets, adoptions, and lost-item notices.",
    searchPhEs: "Buscar mascota, objeto o aviso…",
    searchPhEn: "Search pet, item, or notice…",
    quickFiltersEs: ["Mascota perdida", "Mascota encontrada", "Adopción", "Objeto perdido", "Objeto encontrado", "Urgente"],
    quickFiltersEn: ["Pet lost", "Pet found", "Adoption", "Item lost", "Item found", "Urgent"],
  },
  iglesias: {
    titleEs: "Iglesias",
    titleEn: "Churches",
    ...
    searchPhEs: "Buscar iglesia o comunidad…",
    searchPhEn: "Search church or community…",
