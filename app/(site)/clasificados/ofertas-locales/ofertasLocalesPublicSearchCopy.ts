...
const COPY = {
  es: {
    ...
    searchPlaceholderCompact: "Buscar por ciudad, estado/provincia, país o código postal…",
  ...
  en: {
    ...
    searchPlaceholderCompact: "Search by city, state/province, country, or postal code…",
