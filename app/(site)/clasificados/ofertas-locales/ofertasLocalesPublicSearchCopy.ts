...
const COPY = {
  es: {
    ...
    heroIntro: "Busca productos, precios y cupones en negocios locales.",
    ...
    discoverySubtitle: "Encuentra ofertas reales de negocios locales.",
    ...
    exactSourceHelper: "Abre el volante original para confirmar la página y el producto exacto. No inventamos recortes ni disponibilidad.",
  ...
  en: {
    ...
    heroIntro: "Search products, prices, and coupons from local businesses.",
    heroHelper: "Search by product, city, or postal code; save deals and visit local businesses.",
    ...
    discoverySubtitle: "Find real offers from local businesses.",
    ...
    sms: "SMS",
    businessHubTitle: "Business Hub",
    exactSourceHelper: "Open the original flyer to confirm the exact page and product. We do not invent crops or availability.",
...
const CUPONES_COPY = {
  ...
  en: {
    ...
    pageSubtitle: "Promotions, discounts, and specials from local businesses.",
    heroEyebrow: "LEONIX · LOCAL COUPONS",
    heroTitle: "Save with local business coupons",
    heroTagline: "Promotions, discounts, and specials from local businesses.",
    ...
    discoverySubtitle: "Find promotions and specials from local businesses.",
...
const RESULT_MODE_COPY: Record<OfertasLocalesAppLang, Record<OfertasLocalesResultMode, OfertasLocalesResultModeCopy>> = {
  ...
  en: {
    ...
    food: {
      title: "Food & markets",
      helper: "Find restaurants, markets, and food offers from local businesses.",
      pill: "Food",
