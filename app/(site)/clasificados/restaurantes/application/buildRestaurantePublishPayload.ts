...
export function buildRestaurantePublishPayload(
  ...
  const payload: Record<string, unknown> = {
    ...
    physicalVerificationStatus: blockHeavyMedia(draft.physicalVerificationStatus, "physicalVerificationStatus"),
    physicalProvider: blockHeavyMedia(draft.physicalProvider, "physicalProvider"),
    physicalProviderPlaceId: blockHeavyMedia(draft.physicalProviderPlaceId, "physicalProviderPlaceId"),
    ...
    snapchatUrl: blockHeavyMedia(draft.snapchatUrl, "snapchatUrl"),
