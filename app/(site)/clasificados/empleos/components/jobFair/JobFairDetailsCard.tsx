...
export function JobFairDetailsCard({ title, items }: Props) {
  if (!items.length) return null;
  return (
    <aside className="rounded-lg border border-black/[0.08] bg-white p-5 shadow-[0_2px_16px_rgba(30,24,16,0.05)] sm:p-6">
