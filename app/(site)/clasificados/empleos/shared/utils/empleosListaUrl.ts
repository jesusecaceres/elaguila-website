 ...
 *
 * I.5.8 — canonical results path is the Spanish "/resultados" slug (matches the category route
 * registry's declared resultsRoute and every other category's canonical-Spanish-slug doctrine).
 * "/clasificados/empleos/results" remains live as a compatibility wrapper
 * (app/(site)/clasificados/empleos/results/page.tsx re-exports the resultados page) for any
 * still-reachable older link — it is simply no longer actively generated by this shared builder.
 */
