...
export function mapPublishedQuickToShell(job: EmpleosJobRecord, env: EmpleosPublishEnvelope | null): QuickJobDetailSample {
  if (env?.payload.lane === "quick") {
    ...
    return {
      ...
      smsPhone: d.smsPhone || undefined,
      email: d.email || job.employerEmail || "",
      websiteUrl: web ?? job.employerWebsite,
      contactPerson: d.contactPerson || undefined,
      contactTitle: d.contactTitle || undefined,
      preferredApplyMethod: d.preferredApplyMethod || undefined,
      primaryCta: d.primaryCta,
      workspaceName: d.workspaceName || undefined,
      locationNotes: d.locationNotes || undefined,
      companyLinkedIn: d.companyLinkedIn ? (sanitizeHttpUrl(d.companyLinkedIn) ?? undefined) : undefined,
      companyFacebook: d.companyFacebook ? (sanitizeHttpUrl(d.companyFacebook) ?? undefined) : undefined,
      companyInstagram: d.companyInstagram ? (sanitizeHttpUrl(d.companyInstagram) ?? undefined) : undefined,
      companyTikTok: d.companyTikTok ? (sanitizeHttpUrl(d.companyTikTok) ?? undefined) : undefined,
      companyYouTube: d.companyYouTube ? (sanitizeHttpUrl(d.companyYouTube) ?? undefined) : undefined,
      companyX: d.companyX ? (sanitizeHttpUrl(d.companyX) ?? undefined) : undefined,
      companySnapchat: d.companySnapchat ? (sanitizeHttpUrl(d.companySnapchat) ?? undefined) : undefined,
