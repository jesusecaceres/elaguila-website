...
export const metadata: Metadata = {
  title: "August 2026 Page 5 English Proof QA | Leonix Media",
  description:
    "Temporary internal QA page for the August 2026 Page 5 English digital translation proof.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
const QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-5-english";
const OTHER_QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-6-english";

const SPANISH_SRC = "/qa/magazine/2026-august/page-005/source-page-005-spanish.png";
const ENGLISH_PDF = "/qa/magazine/2026-august/page-005/deepl-page-005.en.pdf";

const DECISION_OPTIONS = [
  {
    label: "APPROVED_FOR_DIGITAL_PROOF",
    hint: "Visible English, layout usable, cards readable — continue proof workflow.",
  },
  {
    label: "FIX_NEEDED",
    hint: "Translation works but needs polish (overflow, spacing, card layout).",
  },
  {
...
const QA_CHECKLIST = [
  ...
  "Are agenda/event cards readable?",
  "Are event names/dates/times preserved?",
  "Is layout usable?",
  "No major card overflow?",
  "No major text crop?",
...
export default function Page5EnglishProofQaPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 rounded-3xl border border-[#D6C7AD] bg-[#FFFDF7] p-6 shadow-[0_20px_60px_-30px_rgba(31,36,28,0.28)] sm:p-8">
          ...
          <h1 className="mt-3 font-serif text-3xl font-bold leading-tight text-[#2A4536] sm:text-5xl">
            Page 5 English Proof QA
          </h1>
          <p className="mt-2 text-sm font-semibold text-[#7A1E2C]">
            Risk: HIGH — dense agenda/event/card layout
          </p>
