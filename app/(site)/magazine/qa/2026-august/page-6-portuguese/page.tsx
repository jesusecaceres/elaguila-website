...
export const metadata: Metadata = {
  title: "August 2026 Page 6 Portuguese Proof QA | Leonix Media",
  description:
    "Temporary internal QA page for the August 2026 Page 6 Portuguese PT-BR digital translation proof.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
const QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-6-portuguese";
const OTHER_QA_URLS = [
...
const SPANISH_SRC = "/qa/magazine/2026-august/page-006-pt/source-page-006-spanish.png";
const PORTUGUESE_PDF = "/qa/magazine/2026-august/page-006-pt/deepl-page-006.pt.pdf";

const DECISION_OPTIONS = [
  {
    label: "APPROVED_FOR_DIGITAL_PROOF_WITH_MINOR_POLISH_NOTES",
    hint: "Visible Portuguese, layout usable, editorial/community tone acceptable — continue proof workflow with minor polish notes.",
  },
  {
    label: "FIX_NEEDED",
...
const QA_CHECKLIST = [
  ...
  "Is editorial/community tone acceptable?",
  "Is business/community language clear?",
  "Are CTAs readable?",
  "Is layout usable?",
  "Any crop/overflow?",
] as const;
...
export default function Page6PortugueseProofQaPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 rounded-3xl border border-[#D6C7AD] bg-[#FFFDF7] p-6 shadow-[0_20px_60px_-30px_rgba(31,36,28,0.28)] sm:p-8">
          ...
          <h1 className="mt-3 font-serif text-3xl font-bold leading-tight text-[#2A4536] sm:text-5xl">
            August 2026 Page 6 Portuguese Proof QA
          </h1>
          <p className="mt-2 text-sm font-semibold text-[#556B3E]">
            Risk: MEDIUM — editorial/community layout
          </p>
        ...
        <section className="mt-6 rounded-2xl border border-[#2A4536]/20 bg-[#2A4536] p-5 text-[#F8F4EA] sm:p-6">
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#C9A84A]">
            Page 6 Portuguese visual QA checklist
          </p>
