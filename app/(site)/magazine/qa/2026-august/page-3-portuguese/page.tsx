...
export const metadata: Metadata = {
  title: "August 2026 Page 3 Portuguese Proof QA | Leonix Media",
  description:
    "Temporary internal QA page for the August 2026 Page 3 Portuguese PT-BR digital translation proof.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
const QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-3-portuguese";
const OTHER_QA_URLS = [
  "https://www.leonixmedia.com/magazine/qa/2026-august/page-12-portuguese",
  "https://www.leonixmedia.com/magazine/qa/2026-august/page-6-portuguese",
] as const;

const SPANISH_SRC = "/qa/magazine/2026-august/page-003-pt/source-page-003-spanish.png";
const PORTUGUESE_PDF = "/qa/magazine/2026-august/page-003-pt/deepl-page-003.pt.pdf";

const DECISION_OPTIONS = [
  {
    label: "APPROVED_FOR_DIGITAL_PROOF_WITH_MINOR_POLISH_NOTES",
    hint: "Visible Portuguese, Cali Bear Tacos preserved, offers/CTA readable — continue proof workflow with minor polish notes.",
  },
  {
    label: "FIX_NEEDED",
...
const QA_CHECKLIST = [
  ...
  "Are food/menu/offer terms acceptable?",
  "Are contact details preserved?",
  "Is client-ad tone acceptable?",
  "Any crop/overflow?",
] as const;
...
export default function Page3PortugueseProofQaPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 rounded-3xl border border-[#D6C7AD] bg-[#FFFDF7] p-6 shadow-[0_20px_60px_-30px_rgba(31,36,28,0.28)] sm:p-8">
          ...
          <h1 className="mt-3 font-serif text-3xl font-bold leading-tight text-[#2A4536] sm:text-5xl">
            August 2026 Page 3 Portuguese Proof QA
          </h1>
        ...
        <section className="mt-6 rounded-2xl border border-[#2A4536]/20 bg-[#2A4536] p-5 text-[#F8F4EA] sm:p-6">
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#C9A84A]">
            Page 3 Portuguese visual QA checklist
          </p>
