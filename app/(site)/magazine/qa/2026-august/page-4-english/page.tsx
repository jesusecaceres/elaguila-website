...
export const metadata: Metadata = {
  title: "August 2026 Page 4 English Proof QA | Leonix Media",
  description:
    "Temporary internal QA page for the August 2026 Page 4 English digital translation proof.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
const QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-4-english";
const OTHER_QA_URLS = [
...
const SPANISH_SRC = "/qa/magazine/2026-august/page-004/source-page-004-spanish.png";
const ENGLISH_PDF = "/qa/magazine/2026-august/page-004/deepl-page-004.en.pdf";

const DECISION_OPTIONS = [
  {
    label: "APPROVED_FOR_DIGITAL_PROOF_WITH_MINOR_POLISH_NOTES",
    hint: "Visible English, business name intact, service copy/CTA readable — continue proof workflow with minor polish notes.",
  },
  {
    label: "FIX_NEEDED",
    hint: "Translation works but needs polish (overflow, spacing, CTA/contact details, tone).",
  },
  {
...
export default function Page4EnglishProofQaPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 rounded-3xl border border-[#D6C7AD] bg-[#FFFDF7] p-6 shadow-[0_20px_60px_-30px_rgba(31,36,28,0.28)] sm:p-8">
          ...
          <h1 className="mt-3 font-serif text-3xl font-bold leading-tight text-[#2A4536] sm:text-5xl">
            Page 4 English Proof QA
          </h1>
          <p className="mt-2 text-sm font-semibold text-[#556B3E]">
            Risk: HIGH — Elevated Barber client service ad
          </p>
