...
export const metadata: Metadata = {
  title: "August 2026 Page 12 English Proof QA | Leonix Media",
  description:
    "Temporary internal QA page for the August 2026 Page 12 English digital translation proof.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
const QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-12-english";

const SPANISH_SRC = "/qa/magazine/2026-august/page-012/source-page-012-spanish.png";
const ENGLISH_PDF = "/qa/magazine/2026-august/page-012/deepl-page-012.en.pdf";

const DECISION_OPTIONS = [
  {
    label: "TRANSLATION_WORKED_ENOUGH_FOR_DIGITAL_PROOF",
    hint: "Visible English, layout usable, contact truth OK — continue proof workflow.",
  },
  {
    label: "TRANSLATION_UNCHANGED_OR_FAILED",
    hint: "Spanish unchanged or output unusable — stop this PNG/PDF path for full issue.",
  },
  {
    label: "NEEDS_EDITABLE_SOURCE_REBUILD",
    hint: "Pivot to Canva/Figma editable text-layer PDF before more proofs.",
  },
  {
    label: "NEEDS_COMPANION_TEXT_LAYER",
...
const QA_CHECKLIST = [
  ...
  "Is layout usable?",
  "No major crop/overflow?",
  "Suite 201 correct?",
  "No Suite 202?",
  "No 275 Coleman?",
  "Phone correct: (408) 360-6500?",
  "Email correct: info@leonixmedia.com?",
  "Website correct: leonixmedia.com?",
  "QR / contact zone readable?",
...
export default function Page12EnglishProofQaPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 rounded-2xl border border-[#C9A84A]/60 bg-[#FFFDF7] p-5 sm:p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#3D3428]">
            Chuy: after reviewing the comparison above, report{" "}
            <strong>one decision label</strong> back to Coach for gate{" "}
            <span className="font-mono">AUGUST-2026-PAGE12-ENGLISH-PROOF-CHUY-DECISION1</span>.
          </p>
        </section>
      </div>
    </main>
