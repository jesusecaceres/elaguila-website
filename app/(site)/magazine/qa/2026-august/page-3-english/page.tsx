...
export const metadata: Metadata = {
  title: "August 2026 Page 3 English Proof QA | Leonix Media",
  description:
    "Temporary internal QA page for the August 2026 Page 3 English digital translation proof.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
const QA_URL = "https://www.leonixmedia.com/magazine/qa/2026-august/page-3-english";
const OTHER_QA_URLS = [
...
const SPANISH_SRC = "/qa/magazine/2026-august/page-003/source-page-003-spanish.png";
const ENGLISH_PDF = "/qa/magazine/2026-august/page-003/deepl-page-003.en.pdf";

const DECISION_OPTIONS = [
  {
    label: "APPROVED_FOR_DIGITAL_PROOF_WITH_MINOR_POLISH_NOTES",
    hint: "Visible English, business name intact, offers/CTA readable — continue proof workflow with minor polish notes.",
  },
  {
    label: "FIX_NEEDED",
    hint: "Translation works but needs polish (overflow, spacing, offer/CTA/contact details).",
  },
  {
...
const QA_CHECKLIST = [
  ...
  "Are offer/CTA/contact details preserved?",
  "Is layout usable?",
  "No major text crop or overflow?",
  "Is premium client-ad tone acceptable?",
...
export default function Page3EnglishProofQaPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 rounded-2xl border border-[#C9A84A]/60 bg-[#FFFDF7] p-5 sm:p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#3D3428]">
            Chuy: review Page 2, Page 3, and Page 4 together, then report{" "}
            <strong>one decision label per page</strong> back to Coach for gate{" "}
            <span className="font-mono">AUGUST-2026-BATCH3-PAGES2-4-CHUY-QA-DECISION1</span>.
          </p>
        </section>
      </div>
    </main>
