...
import { getNegociosFeaturedOfertasCopy } from "../_lib/negociosLocalesLandingHubCopy";
...
export function NegociosLocalesFeaturedOfertasModule({ routeLang }: Props) {
  const copy = getNegociosFeaturedOfertasCopy(routeLang);
  ...
  return (
    <section
      ...
      aria-labelledby="negocios-featured-ofertas-title"
    >
      <div
      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:gap-8">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[0.65rem] font-bold uppercase tracking-[0.16em] text-[#7A1E2C]">
            {routeLang === "en" ? "For local businesses" : "Para negocios locales"}
          </p>
          <h2 id="negocios-featured-ofertas-title" className="mt-1 text-2xl font-bold text-[#1E1810] sm:text-[1.65rem]">
            {copy.title}
          </h2>
