...
const AUTOS_BASE_PACKAGE_KEYS: ReadonlySet<string> = new Set([
  "autos_privado_30d",
  "autos_dealer_monthly",
  // golden-survivor port: the Quick dealer base (SIMPLE) is also a base purchase of the application row.
