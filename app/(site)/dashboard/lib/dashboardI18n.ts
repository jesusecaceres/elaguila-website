...
export function dashboardShellCopy(lang: Lang) {
  if (lang === "es") {
    return {
      ...
      businessTools: "Herramientas y Concierge",
      saved: "Guardados",
      ...
      navGroupMisEspacios: "Mis espacios",
      navSpaceRestaurantes: "Restaurantes",
      navSpaceEmpleos: "Empleos",
      navSpaceViajes: "Viajes",
      openMenu: "Abrir menú",
  ...
  return {
    ...
    businessTools: "Business Tools & Concierge",
    saved: "Saved",
    ...
    navGroupMisEspacios: "My spaces",
    navSpaceRestaurantes: "Restaurants",
    navSpaceEmpleos: "Jobs",
    navSpaceViajes: "Travel",
    openMenu: "Open menu",
...
export function businessHomeCopy(lang: Lang) {
  return lang === "es"
    ? {
        ...
        workWithLeonixReadOnlyNote: "Resumen de solo lectura — tu equipo Leonix te contactará para cada aprobación o solicitud pendiente.",
    ...
    : {
        ...
        workWithLeonixReadOnlyNote: "Read-only summary — your Leonix team will reach out for each pending approval or request.",
