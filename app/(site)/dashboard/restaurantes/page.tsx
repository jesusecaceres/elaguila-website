    ...
    () =>
      lang === "es"
        ? {
            ...
            errRl: "No pudimos cargar tus restaurantes. Verifica tu sesión e intenta de nuevo.",
        ...
        : {
            ...
            cardUpdated: "Updated",
            errRl: "We couldn't load your restaurants. Check that you're signed in and try again.",
