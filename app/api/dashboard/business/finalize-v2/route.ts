...
import { finalizeBusinessIdentityV2 } from "@/app/lib/business/services/finalizeBusinessV2";
...
/** POST /api/dashboard/business/finalize-v2 — Gate BCO-3R atomic Business Identity creation (9-step flow). */
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  const result = await finalizeBusinessIdentityV2(getAdminSupabase(), userClient, {
    userId,
