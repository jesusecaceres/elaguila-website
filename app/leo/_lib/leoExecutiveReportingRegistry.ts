...
export const LEO_EXECUTIVE_DOMAIN_REGISTRY: readonly LeoExecutiveDomainRegistryEntry[] = [
  ...
  },
  {
    ...
    label: "Business Concierge pipeline",
    canonicalAdminRoute: "/admin/businesses",
    adapterStatus: "LIVE",
    supportsAttention: true,
    supportsMetrics: true,
    supportsWatch: true,
    notes: "LEO-ADMIN-OS-FINAL.2: canonical businesses/business_follow_ups pipeline — not leonix_leads/support_tickets.",
  },
  {
    domain: "TEAM",
    label: "Team",
    canonicalAdminRoute: "/admin/team/roster",
    adapterStatus: "LIVE",
    supportsAttention: false,
    supportsMetrics: true,
    supportsWatch: false,
    notes: "admin_team_members roster counts (bounded to 80, single flat roster).",
  },
  {
    domain: "CATEGORIES",
    label: "Categories",
    canonicalAdminRoute: ADMIN_DASHBOARD_ROUTES.categories,
    adapterStatus: "PARTIAL",
    supportsAttention: true,
    supportsMetrics: true,
    supportsWatch: false,
    notes: "Category registry lifecycle counts are live; per-category pending counts are derived from a bounded sitewide preview.",
  },
  {
    domain: "RECURSOS",
    label: "Recursos",
    canonicalAdminRoute: "/admin/recursos",
    adapterStatus: "LIVE",
    supportsAttention: true,
    supportsMetrics: true,
    supportsWatch: true,
    notes: "Reuses the same 5 canonical Recursos read functions the admin page itself calls.",
  },
  {
    domain: "WEBSITE",
    label: "Website / Site Settings",
    canonicalAdminRoute: ADMIN_DASHBOARD_ROUTES.siteSettings,
    adapterStatus: "PARTIAL",
    supportsAttention: false,
    supportsMetrics: false,
    supportsWatch: false,
    notes: "Editability is a static code-authored truth table; only one live timestamp (global_site last-updated) exists.",
  },
];
