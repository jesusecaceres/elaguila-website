...
export function getBusinessCardTemplateFront(
  ...
  switch (templateId) {
    ...
    case "gold-accent-executive":
      return {
        fields: f,
        logoGeom: { xPct: 50, yPct: 26, widthPct: 20, zIndex: 5 },
        blocks: [
          block("t0", "tagline", "—", 50, 38, 70, 8, 600, "center", 4, "#b8923a"),
          block("t1", "company", f.company, 50, 46, 86, 13, 700, "center", 5, "#2c261c"),
          block("t2", "personName", f.personName, 50, 58, 86, 11, 600, "center", 6, ink),
          block("t3", "title", f.title, 50, 68, 86, 10, 500, "center", 7, mutedDark),
          block("t4", "phone", f.phone, 50, 80, 86, 9, 500, "center", 8, "#2c261c"),
        ],
      };
    case "clean-white-premium":
      return {
        ...
        blocks: [
          block("t1", "company", f.company, 50, 44, 88, 13, 700, "center", 5, ink),
          block("t2", "personName", f.personName, 50, 56, 88, 11, 600, "center", 6, ink),
          block("t3", "title", f.title, 50, 65, 88, 10, 500, "center", 7, mutedDark),
          block("t4", "phone", f.phone, 50, 76, 88, 9, 400, "center", 8, ink),
          block("t5", "email", f.email, 50, 84, 88, 9, 400, "center", 9, ink),
        ],
      };
    case "bold-modern-slab":
      return {
    ...
    case "monochrome-power":
      return {
        fields: f,
        logoGeom: { xPct: 22, yPct: 32, widthPct: 20, zIndex: 4 },
        blocks: [
          block("t1", "company", f.company, 62, 34, 68, 12, 700, "left", 5, "#111113"),
          block("t2", "personName", f.personName, 62, 46, 68, 11, 600, "left", 6, "#111113"),
          block("t3", "title", f.title, 62, 56, 68, 9, 500, "left", 7, "rgba(17,17,19,0.55)"),
          block("t4", "phone", f.phone, 62, 70, 68, 9, 500, "left", 8, "#111113"),
          block("t5", "email", f.email, 62, 80, 68, 8, 400, "left", 9, "rgba(17,17,19,0.75)"),
        ],
      };
    case "luxe-editorial":
      return {
        fields: f,
        logoGeom: { xPct: 50, yPct: 78, widthPct: 16, zIndex: 4 },
        blocks: [
          block("t1", "personName", f.personName, 50, 30, 80, 15, 600, "center", 5, "#2c261c"),
          block("t2", "title", f.title, 50, 44, 72, 9, 500, "center", 6, "rgba(44,38,28,0.65)"),
          block("t3", "company", f.company, 50, 54, 80, 11, 700, "center", 7, "#2c261c"),
          block("t4", "tagline", f.tagline, 50, 64, 78, 9, 400, "center", 8, "rgba(44,38,28,0.55)"),
          block("t5", "email", f.email, 50, 76, 80, 8, 400, "center", 9, "#2c261c"),
        ],
      };
    ...
    case "leonix-crest-mark":
      return {
        fields: f,
        logoGeom: { xPct: 50, yPct: 38, widthPct: 30, zIndex: 8 },
        blocks: [
          block("t1", "company", f.company, 50, 72, 88, 11, 700, "center", 5, "#d4af37"),
          block("t2", "personName", f.personName, 50, 82, 88, 10, 500, "center", 6, "rgba(255,252,247,0.9)"),
        ],
      };
...
export function getBusinessCardTemplateBack(
  ...
  if (useMap) {
    return {
      ...
      blocks: [
        block("b1", "company", f.company, 50, 40, 88, 12, 700, "center", 5, ink),
        block("b2", "address", f.address, 50, 54, 86, 9, 500, "center", 6, muted),
        block("b3", "tagline", f.tagline, 50, 72, 86, 9, 500, "center", 7, ink),
      ],
    };
  }
  ...
  return {
    ...
    logoGeom: { xPct: 50, yPct: 50, widthPct: 18, zIndex: 4 },
    blocks: [
      block("b1", "company", f.company, 50, 44, 86, 13, 700, "center", 5, ink),
      block("b2", "tagline", f.tagline, 50, 58, 86, 10, 500, "center", 6, muted),
    ],
  };
}
