...
export type BusinessCardTemplateId =
  ...
  | "bilingual-dual-line"
  | "ivory-executive-band"
  | "carbon-soft-elevated"
  | "azure-confidence-strip"
  | "saffron-edge-dynamic"
  | "realtor-elevated-gold"
  | "wellness-sage-soft"
  | "studio-rose-line"
  | "sanctuary-burgundy-warm"
  | "bilingual-ribbon-feature"
  | "bilingual-inline-stack"
  | "leonix-orbit-halo"
  | "leonix-ledger-stripe";
...
export const BUSINESS_CARD_TEMPLATE_LIBRARY: Record<BusinessCardTemplateId, BusinessCardTemplateMeta> = {
  ...
  "ivory-executive-band": {
    id: "ivory-executive-band",
    slug: "ivory-executive-band",
    family: "universal",
    title: { es: "Ivory · banda ejecutiva", en: "Ivory executive band" },
    subtitle: { es: "Franja superior oro, jerarquía limpia.", en: "Gold top band, clean hierarchy." },
    styleFamily: "universal-premium",
    primaryColor: "#faf6f0",
    accentColor: "#a67c2a",
    featured: true,
  ...
  "carbon-soft-elevated": {
    id: "carbon-soft-elevated",
    slug: "carbon-soft-elevated",
    family: "universal",
    title: { es: "Carbono suave", en: "Soft carbon" },
    subtitle: { es: "Gris profundo, tipografía elevada.", en: "Deep gray, elevated type." },
    styleFamily: "universal-premium",
    primaryColor: "#2a2a2e",
    accentColor: "#e8dcc8",
    featured: true,
  ...
  "azure-confidence-strip": {
    id: "azure-confidence-strip",
    slug: "azure-confidence-strip",
    family: "universal",
    title: { es: "Azul confianza", en: "Azure confidence" },
    subtitle: { es: "Blanco, acento azul — confianza corporativa.", en: "White, blue accent — corporate trust." },
    styleFamily: "universal-premium",
    primaryColor: "#f8fafc",
    accentColor: "#1e3a5f",
    featured: true,
  ...
  "saffron-edge-dynamic": {
    id: "saffron-edge-dynamic",
    slug: "saffron-edge-dynamic",
    family: "universal",
    title: { es: "Borde azafrán", en: "Saffron edge" },
    subtitle: { es: "Columna cálida lateral, energía moderna.", en: "Warm side column, modern energy." },
    styleFamily: "universal-premium",
    primaryColor: "#fffdf7",
    accentColor: "#d97706",
    featured: false,
  ...
  "realtor-elevated-gold": {
    id: "realtor-elevated-gold",
    slug: "realtor-elevated-gold",
    family: "industry",
    title: { es: "Inmobiliaria · oro elevado", en: "Realtor elevated gold" },
    subtitle: { es: "Cielo y franja clara — contacto premium.", en: "Sky field + light strip — premium contact." },
    styleFamily: "industry-flex",
    primaryColor: "#e8eef2",
    accentColor: "#b8860b",
    featured: true,
    recommendedSidedness: "both",
    mapBlockOnBack: true,
    industryTags: ["real estate", "realtor"],
  },
  "wellness-sage-soft": {
    id: "wellness-sage-soft",
    slug: "wellness-sage-soft",
    family: "industry",
    title: { es: "Wellness salvia", en: "Wellness sage" },
    subtitle: { es: "Verde suave, clínico y humano.", en: "Soft green, clinical yet human." },
    styleFamily: "industry-flex",
    primaryColor: "#ecfdf5",
    accentColor: "#0f766e",
    featured: false,
    recommendedSidedness: "both",
    mapBlockOnBack: true,
    industryTags: ["dental", "medical", "wellness"],
  },
  "studio-rose-line": {
    id: "studio-rose-line",
    slug: "studio-rose-line",
    family: "industry",
    title: { es: "Estudio rosa", en: "Rose studio" },
    subtitle: { es: "Barber/beauty — línea fina y acento rosa.", en: "Barber/beauty — fine line and rose accent." },
    styleFamily: "industry-flex",
    primaryColor: "#fdf2f8",
    accentColor: "#9d174d",
    featured: false,
    recommendedSidedness: "both",
    mapBlockOnBack: false,
    industryTags: ["salon", "beauty", "barber"],
  },
  "sanctuary-burgundy-warm": {
    id: "sanctuary-burgundy-warm",
    slug: "sanctuary-burgundy-warm",
    family: "industry",
    title: { es: "Comunidad cálida", en: "Warm sanctuary" },
    subtitle: { es: "Borgoña profundo, texto crema — iglesia y comunidad.", en: "Deep burgundy, cream type — church & community." },
    styleFamily: "industry-flex",
    primaryColor: "#3f1d1d",
    accentColor: "#f5e6c8",
    featured: false,
    recommendedSidedness: "both",
    mapBlockOnBack: true,
    industryTags: ["church", "community", "faith"],
  },
  "bilingual-ribbon-feature": {
    id: "bilingual-ribbon-feature",
    slug: "bilingual-ribbon-feature",
    family: "bilingual",
    title: { es: "Bilingüe · cinta", en: "Bilingual ribbon" },
    subtitle: { es: "Franja bilingüe y contacto en bloque.", en: "Bilingual ribbon band + contact block." },
    styleFamily: "bilingual",
    primaryColor: "#fffdf9",
    accentColor: "#1c1914",
    featured: true,
  ...
  "bilingual-inline-stack": {
    id: "bilingual-inline-stack",
    slug: "bilingual-inline-stack",
    family: "bilingual",
    title: { es: "Bilingüe · apilado", en: "Bilingual inline stack" },
    subtitle: { es: "Título y rol en líneas ES/EN.", en: "Title and role in stacked ES/EN lines." },
    styleFamily: "bilingual",
    primaryColor: "#f8f6f1",
    accentColor: "#3d3428",
    featured: false,
  ...
  "leonix-orbit-halo": {
    id: "leonix-orbit-halo",
    slug: "leonix-orbit-halo",
    family: "signature",
    title: { es: "Leonix · órbita", en: "Leonix orbit halo" },
    subtitle: { es: "Logo hero con halo circular — sello Leonix.", en: "Logo hero with circular halo — Leonix stamp." },
    styleFamily: "leonix-signature",
    primaryColor: "#0e0e10",
    accentColor: "#d4af37",
    featured: true,
  ...
  "leonix-ledger-stripe": {
    id: "leonix-ledger-stripe",
    slug: "leonix-ledger-stripe",
    family: "signature",
    title: { es: "Leonix · libro mayor", en: "Leonix ledger stripe" },
    subtitle: { es: "Franja inferior contable, oro sobre carbón.", en: "Bottom ledger stripe, gold on carbon." },
    styleFamily: "leonix-signature",
    primaryColor: "#121214",
    accentColor: "#c9a84a",
    featured: true,
