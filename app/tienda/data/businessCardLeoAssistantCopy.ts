...
export const leoAssistCopy = {
  ...
  preferredColors: { es: "Palabras de color (opcional)", en: "Color keywords (optional)" },
  preferredColorsHelp: {
    es: "LEO interpreta palabras comunes (negro, blanco, dorado, etc.) para priorizar plantillas con fondos similares. No sustituye elegir el fondo en el editor.",
    en: "LEO reads plain words (black, white, gold, etc.) to rank templates with similar backgrounds. It does not replace picking the canvas in the editor.",
  },
  emphasis: { es: "Enfoque principal (frente)", en: "Primary focus (front)" },
  emphasisSecondary: { es: "Enfoque secundario (opcional)", en: "Secondary focus (optional)" },
  emphasisSecondaryNone: { es: "Ninguno", en: "None" },
