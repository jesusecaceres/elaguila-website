  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <AdminPageHeader
        ...
        subtitle={`ID ${item.id} · last updated ${new Date(item.updated_at).toLocaleString("en-US")}`}
        helperText="This record covers copy, pricing, visibility, images, and primary photo — same flow as before; header updated for the team."
        rightSlot={
