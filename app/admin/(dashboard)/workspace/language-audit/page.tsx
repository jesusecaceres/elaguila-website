...
const AUDIT_ROWS: { sectionKey: string; notesKey: string; enDefault: boolean; esToggle: boolean }[] = [
  { sectionKey: "languageAudit.section.dashboard", notesKey: "languageAudit.notes.dashboard", enDefault: false, esToggle: false },
  { sectionKey: "languageAudit.section.categories", notesKey: "languageAudit.notes.categories", enDefault: false, esToggle: false },
  {
    sectionKey: "languageAudit.section.clasificadosWorkspace",
    notesKey: "languageAudit.notes.clasificadosWorkspace",
    enDefault: true,
    esToggle: true,
  },
  {
    sectionKey: "languageAudit.section.clasificadosQueues",
    notesKey: "languageAudit.notes.clasificadosQueues",
    enDefault: false,
    esToggle: false,
  },
  {
    sectionKey: "languageAudit.section.restaurantesQueue",
    notesKey: "languageAudit.notes.restaurantesQueue",
    enDefault: false,
    esToggle: false,
  },
  {
    sectionKey: "languageAudit.section.serviciosQueue",
    notesKey: "languageAudit.notes.serviciosQueue",
    enDefault: false,
    esToggle: false,
  },
  {
    sectionKey: "languageAudit.section.empleosQueue",
    notesKey: "languageAudit.notes.empleosQueue",
    enDefault: false,
    esToggle: false,
  },
  { sectionKey: "languageAudit.section.autosQueue", notesKey: "languageAudit.notes.autosQueue", enDefault: false, esToggle: false },
  { sectionKey: "languageAudit.section.tienda", notesKey: "languageAudit.notes.tienda", enDefault: false, esToggle: false },
  { sectionKey: "languageAudit.section.users", notesKey: "languageAudit.notes.users", enDefault: false, esToggle: false },
  { sectionKey: "languageAudit.section.payments", notesKey: "languageAudit.notes.payments", enDefault: false, esToggle: false },
  { sectionKey: "languageAudit.section.support", notesKey: "languageAudit.notes.support", enDefault: false, esToggle: false },
  { sectionKey: "languageAudit.section.settings", notesKey: "languageAudit.notes.settings", enDefault: false, esToggle: false },
];
