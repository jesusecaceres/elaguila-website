...
export default async function AdminViajesStagedListingDetailPage({
  ...
  // Defense-in-depth: the (dashboard) layout already gates with requireAdminCookie, but layouts are not
  // re-run on soft navigation, and this page shows submitter contact + staff-only location data.
      ...
      <div className="space-y-4">
        <Section title="Identity">
          <dl className="space-y-2">
            ...
            <Kv k="Stored shape" v={d.sourceShape} />
