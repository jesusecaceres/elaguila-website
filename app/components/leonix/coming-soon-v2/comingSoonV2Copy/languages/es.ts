  ...
  return localizeComingSoonV2Copy(lang, {
    ...
    marketplace: {
      ...
      featuredCard: {
        ...
        body:
          "Volantes, cupones y especiales semanales de negocios locales en una experiencia clara, diseñada para que la comunidad descubra ahorros reales y los negocios ganen más visibilidad.",
        supportingLine:
          "Más razones para visitar Leonix significa más oportunidades para que los negocios sean vistos.",
      },
    ...
    mediaKitPreview: {
      ...
      dualPdfEsLabel: "Descargar Media Kit",
      dualPdfEnLabel: "Media Kit (PDF en inglés)",
    ...
    newsletter: {
      ...
      body: "Regístrate y te avisaremos cuando lancemos, además de novedades y beneficios para anunciantes.",
      placeholder: "Tu correo electrónico",
      button: "Notifícame",
      formAria: "Registro al boletín",
      emailLabel: "Correo electrónico",
      consent: "Acepto recibir actualizaciones del lanzamiento de Leonix Media.",
      consentError: "Confirma el consentimiento para recibir actualizaciones.",
    },
