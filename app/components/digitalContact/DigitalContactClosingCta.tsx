...
export function DigitalContactClosingCta({ profileSlug, copy }: Props) {
  return (
    <section className="mx-auto w-full max-w-2xl px-5 pt-12 sm:px-6 sm:pt-14">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#7A1E2C] to-[#4f1319] p-8 text-center shadow-lg sm:p-10">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_0%,rgba(201,168,74,0.22),transparent_60%)]"
        />
        ...
        <a
          ...
          className="relative mt-6 inline-flex min-h-[48px] items-center justify-center rounded-xl bg-[#C9A84A] px-8 py-3 text-sm font-bold text-[#1F241C] shadow-md transition hover:bg-[#d4bc6a] active:scale-[0.99]"
        >
          {copy.closingCta}
        </a>
      </div>
