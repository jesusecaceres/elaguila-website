  ...
  return (
    <section aria-labelledby="dc-showcase-title" className="mx-auto w-full max-w-2xl px-5 pt-12 sm:px-6 sm:pt-14">
      <div className="text-center">
        {/* Fixed Leonix Media parent-brand mark — intentionally not theme-driven; every executive profile is still a Leonix Media entity. */}
      ...
      <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
        {DIGITAL_CONTACT_SHOWCASE_ITEMS.map((item) => (
          <Link
            ...
            className="group flex flex-col rounded-2xl border border-[#D6C7AD] bg-[#FFFDF7] p-4 shadow-sm transition hover:border-[var(--dc-accent)] hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--dc-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F8F4EA]"
          >
            <span className="text-sm font-bold text-[var(--dc-primary)] group-hover:underline">
