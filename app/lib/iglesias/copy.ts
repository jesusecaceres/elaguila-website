...
const ES: IglesiasCopy = {
  ...
  churchCtaBody: "Envía los datos de tu congregación. Las solicitudes claras pueden publicarse automáticamente; las excepciones requieren revisión.",
  ...
  applyPrayerTeamHelp: "Esto solo indica interés. La Red de Oración requiere aprobación administrativa por separado.",
...
const EN: IglesiasCopy = {
  ...
  churchCtaBody: "Submit your congregation. Clear applications may publish automatically; exceptions require review.",
  ...
  applyPrayerTeamHelp: "This only indicates interest. Prayer Network participation requires separate admin approval.",
