...
export const MEDIA_KIT_PAGE_TL: MediaKitPageCopy = {
  ...
  hero: {
    ...
    positioning:
      "Print advertising sa Espanyol, bilingual digital exposure, at multilingual QR access.",
    requestAdCta: "Humiling ng impormasyon sa advertising",
    downloadCta: "I-download ang Media Kit",
  },
  whatWeOffer: {
  ...
  whyAdvertise: {
    eyebrow: "Bakit mag-advertise",
    headline: "Bakit pinipili ng mga negosyo ang Leonix Media",
    points: [
      {
        title: "Abutin ang local Latino at multicultural communities",
        body: "Kumonekta sa mga mambabasang pinahahalagahan ang trusted local media at community-first discovery.",
      },
      {
        title: "I-convert ang print attention sa digital action",
        body: "Gawing tawag, map, mensahe, at website visit ang magazine visibility sa pamamagitan ng QR at action buttons.",
      },
      {
        title: "Magbigay ng malinaw na contact paths",
        body: "Phone, email, map, website, at social paths ang tumutulong sa customer na makipag-ugnayan nang madali.",
      },
      {
        title: "Suportahan ang local business discovery",
        body: "Sumali sa platform na ginawa para mas maging malakas at mas madaling kontakin ang local na negosyo.",
      },
    ],
  },
  packages: {
  ...
  downloads: {
    ...
    enPdfLabel: "Official Media Kit PDF (English)",
    downloadAction: "I-download ang PDF",
  },
  contactCta: {
    headline: "Handa nang mag-advertise sa Leonix?",
    body: "Gamitin ang native Leonix contact forms para sa advertising information, media kit requests, at next steps. Available pa rin ang native forms sa napili mong wika.",
    primaryCta: "Humiling ng impormasyon sa advertising",
    mediaKitInterestCta: "Humiling ng detalye ng Media Kit",
  },
  googleTranslate: {
    question: "Kailangan ng ibang wika?",
    body: "Buksan ang website na ito gamit ang Google Translate para mag-browse. Available pa rin ang native Leonix forms sa napili mong wika.",
    cta: "Isalin ang website gamit ang Google",
  },
  backToComingSoon: "Bumalik sa Leonix home",
};
