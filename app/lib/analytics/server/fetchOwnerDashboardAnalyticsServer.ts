...
function totalsToListingMetrics(totals: DashboardAnalyticsTotals) {
  return {
    ...
    flyer_page_views: totals.flyer_page_views,
    product_impressions: totals.product_impressions,
    product_opens: totals.product_opens,
    product_searches: totals.product_searches,
    product_search_result_clicks: totals.product_search_result_clicks,
