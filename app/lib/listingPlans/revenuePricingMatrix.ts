...
export const REVENUE_V1_PACKAGE_MATRIX: RevenuePackageDefinition[] = [
  ...
  },
  {
    ...
    customerType: "dealer_business",
    label: "Autos dealer Quick monthly (Simple)",
    priceCents: 9900,
    billingMode: "monthly_subscription",
    durationDays: null,
    ...
    placementEligible: false,
    stripeEligible: true,
    verifiedIntroDiscountEligible: false,
    unresolvedOwnerDecision: null,
    capabilities: [],
  ...
  },
  {
    ...
    customerType: "agent_business",
    label: "Bienes Raíces agent Quick monthly (Simple)",
    priceCents: 9900,
    billingMode: "monthly_subscription",
    durationDays: null,
  ...
  },
  {
    ...
    customerType: "restaurant_business",
    label: "Restaurantes Quick monthly (Simple)",
    priceCents: 9900,
    billingMode: "monthly_subscription",
    durationDays: null,
    includedInventory: "1 profile/listing",
  ...
  },
  {
    ...
    customerType: "service_business",
    label: "Servicios Quick monthly (Simple)",
    priceCents: 9900,
    billingMode: "monthly_subscription",
    durationDays: null,
    includedInventory: "1 profile/listing",
