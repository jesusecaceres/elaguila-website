...
export function revenueCheckoutRefusalMessage(code: string | null | undefined, lang: "es" | "en"): string | null {
  ...
  switch (String(code ?? "")) {
    ...
    case "viajes_checkout_not_available":
      return es
        ? "El pago en línea para negocios de Viajes aún no está disponible. No se inició ningún cobro. Contacta a Leonix."
        : "Online payment for Viajes businesses is not available yet. No charge was started. Contact Leonix.";
    default:
      return null;
  }
}
