...
export const WHO_IS_YOUR_CUSTOMER_AUDIO: LessonAudio = {
  ...
  segments: [
    ...
    },
    {
      ...
      text: {
        es: "Tu acción de hoy es pequeña, pero poderosa. Completa esta frase con tus propias palabras: “Ayudo a… que necesita… en… Y me eligen porque…”. Por ejemplo, Rosa diría: “Ayudo a familias de mi vecindario que necesitan un pastel de cumpleaños personalizado, y me eligen porque lo hago a su gusto con pocos días de aviso”. Tu primera versión no tiene que ser perfecta. De hecho, no lo será. Es una suposición, y las suposiciones se comprueban. Por eso, esta semana, habla con tres clientes reales, o con tres personas que podrían serlo, y pregúntales por qué te compraron, o qué les haría comprarte. Lo que ellos te digan vale más que cualquier cosa que tú o yo imaginemos.",
        en: "Your action for today is small, but powerful. Finish this sentence in your own words: “I help… who need… in… And they choose me because…”. For example, Rosa would say: “I help families in my neighborhood who need a custom birthday cake, and they choose me because I make it the way they want with just a few days' notice.” Your first version doesn't have to be perfect. In fact, it won't be. It's an assumption, and assumptions get checked. So this week, talk with three real customers, or three people who could become one, and ask why they bought from you, or what would make them buy. What they tell you is worth more than anything you or I could imagine.",
      },
    },
    {
      id: "parked",
