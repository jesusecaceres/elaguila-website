...
export const WHAT_PROBLEM_DO_YOU_SOLVE_AUDIO: LessonAudio = {
  ...
  segments: [
    ...
    },
    {
      ...
      text: {
        es: "Repasemos. Nadie se despierta queriendo tu producto; la gente busca que alguien resuelva un problema real, con utilidad y honestidad. Un problema de verdad tiene tres señales: le pasa a alguien concreto, pasa seguido, y esa persona ya hace algo al respecto. Y tu frase del problema es una hipótesis: algo que crees, no algo que ya comprobaste.",
        en: "Let's review. Nobody wakes up wanting your product; people look for someone to solve a real problem, usefully and honestly. A real problem has three signs: it happens to someone specific, it happens often, and that person already does something about it. And your problem sentence is a hypothesis: something you believe, not something you've proven.",
      },
    },
    {
      id: "next",
