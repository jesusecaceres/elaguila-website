...
export const WEBSITE_BLUEPRINT_CATEGORIES: readonly BlueprintCategoryDefinition[] = [
  ...
  { mdNumber: 23, key: "domain_dns", labelEs: "Dominio/DNS", labelEn: "Domain/DNS", render: (p) => domainDnsBlock(p.architecture, p.domainDetails) },
  { mdNumber: 24, key: "hosting_deployment", labelEs: "Alojamiento/Despliegue", labelEn: "Hosting/Deployment", render: (p) => hostingDeploymentBlock(p.architecture, p.hostingDetails) },
  ...
  { mdNumber: 31, key: "ownership_billing", labelEs: "Propiedad/Facturación", labelEn: "Ownership/Billing", render: (p) => ownershipBlock(p.architecture, p.ownershipDetails) },
