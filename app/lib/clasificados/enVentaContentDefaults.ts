...
export const EN_VENTA_HUB_LANDING_DEFAULTS: {
  ...
  es: {
    ...
    browseChipFeatured: "Destacados Pro",
    browseChipPickup: "Recogida local",
    exposureHint:
      "Los anuncios con visibilidad Pro se muestran arriba cuando hay listados destacados.",
  ...
  en: {
    ...
    browseChipFeatured: "Pro featured",
    browseChipPickup: "Local pickup",
    exposureHint: "Pro visibility listings appear at the top when featured placements are available.",
