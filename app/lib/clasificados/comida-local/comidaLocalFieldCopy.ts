...
export const COMIDA_LOCAL_FIELD_COPY: Record<string, ComidaLocalFieldCopy> = {
  ...
  googleReviewsUrl: {
    ...
    helperEs: "Enlace real a tu perfil de Google. Solo se muestra si es válido — nunca inventamos una calificación.",
    helperEn: "Real link to your Google profile. Only shows if it's valid — we never invent a rating.",
    placeholderEs: "https://g.page/…",
    placeholderEn: "https://g.page/…",
    optional: true,
  },
  yelpReviewsUrl: {
    labelEs: "Reseñas de Yelp",
    labelEn: "Yelp reviews",
    helperEs: "Enlace real a tu perfil de Yelp. Solo se muestra si es válido — nunca inventamos una calificación.",
    helperEn: "Real link to your Yelp profile. Only shows if it's valid — we never invent a rating.",
    placeholderEs: "https://www.yelp.com/biz/…",
    placeholderEn: "https://www.yelp.com/biz/…",
    optional: true,
  },
  locationNote: {
