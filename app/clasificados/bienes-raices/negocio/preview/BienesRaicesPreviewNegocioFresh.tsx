...
export default function BienesRaicesPreviewNegocioFresh({
  ...
  return (
    <div
      ...
      data-publish-ready={hooks?.branch === "negocio" ? (hooks.publishReady ? "true" : "false") : undefined}
      data-analytics-ready={hooks?.branch === "negocio" ? (hooks.analyticsReady ? "true" : "false") : undefined}
    >
