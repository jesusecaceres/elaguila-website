  ...
  return (
    <label className={cx("block", className)}>
      ...
      <input
        {...props}
        className={cx(
          "mt-1.5 w-full rounded-xl border border-black/15 bg-white px-3 py-2.5 text-sm text-[#111111] shadow-sm outline-none placeholder:text-[#111111]/35 focus:border-[#A98C2A]/50 focus:ring-2 focus:ring-[#A98C2A]/20",
          inputClassName
        )}
      />
    </label>
