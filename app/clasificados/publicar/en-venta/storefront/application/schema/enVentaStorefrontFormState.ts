...
/**
 * Storefront lane — business/store seller presence (future product).
 * Kept separate from Pro (premium single listing). Not publicly wired yet.
 */
export type EnVentaStorefrontApplicationState = EnVentaFreeApplicationState & {
...
export function createEmptyEnVentaStorefrontState(): EnVentaStorefrontApplicationState {
  return {
    ...createEmptyEnVentaFreeState(),
    seller_kind: "",
    businessDisplayName: "",
