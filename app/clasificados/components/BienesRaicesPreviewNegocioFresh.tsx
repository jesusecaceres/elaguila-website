...
/** BR negocio publish preview: clean 2-col layout (main | sidebar). Expects `listing.businessRail`. */
  ...
  return (
    ...
    >
      <div className="p-4 sm:p-5">
            ...
            {/*
              Clean desktop: main | sidebar (22–24rem). Left: hero|2×2 → property card → description stack.
            */}
            <div className="min-w-0 flex flex-col gap-4 sm:gap-5 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(22rem,24rem)] lg:items-start lg:gap-x-8">
              <div className="min-w-0 flex w-full flex-col gap-4 sm:gap-5 lg:min-w-0">
                <div className="flex w-full min-w-0 flex-col gap-4 sm:gap-4 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(14rem,18rem)] lg:items-start lg:gap-4">
              ...
              <div className="w-full min-w-0 lg:min-w-0 lg:max-w-full">
