  ...
  const copy = useMemo(() => {
    const c = {
      es: {
        ...
        tooltipAsistencia: "Impulso de visibilidad. Tu anuncio aparecerá más arriba en los resultados de búsqueda por 48 horas.",
      ...
      en: {
        ...
        tooltipAsistencia: "Visibility boost. Your listing will appear higher in search results for 48 hours.",
