...
const COPY = {
  es: {
    title: "Empleos",
    subtitle: "Oportunidades de trabajo cerca de ti.",
    searchPlaceholder: "Buscar: trabajo, empresa, jornada…",
    buttonView: "Ver anuncios",
    buttonPost: "Publicar anuncio",
  },
  en: {
    title: "Jobs",
    subtitle: "Job opportunities near you.",
    searchPlaceholder: "Search: job, company, shift…",
