...
const COPY = {
  es: {
    title: "Clases",
    subtitle: "Aprende y comparte: idiomas, música, tutoría y más.",
    searchPlaceholder: "Buscar: inglés, guitarra, tutoría…",
    buttonView: "Ver anuncios",
    buttonPost: "Publicar anuncio",
  },
  en: {
    title: "Classes",
    subtitle: "Learn and share: languages, music, tutoring and more.",
    searchPlaceholder: "Search: English, guitar, tutoring…",
