...
const COPY = {
  es: {
    title: "Autos",
    subtitle: "Encuentra autos, camionetas y ofertas de dealers cerca de ti.",
    searchPlaceholder: "Buscar: Toyota, 2016, camioneta…",
    buttonView: "Ver anuncios",
    buttonPost: "Publicar anuncio",
  },
  en: {
    title: "Autos",
    subtitle: "Find cars, trucks and dealer offers near you.",
    searchPlaceholder: "Search: Toyota, 2016, truck…",
