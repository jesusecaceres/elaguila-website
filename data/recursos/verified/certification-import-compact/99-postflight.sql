-- Recursos Build 03C-COMPACT — Certification import postflight (READ-ONLY)
-- Identical truth contract to data/recursos/verified/certification-import/99-postflight.sql —
-- the transport format changed, not what "done" means. Run this AFTER all 7 batch files
-- complete. Makes no writes. One combined result set proving every required post-condition.
